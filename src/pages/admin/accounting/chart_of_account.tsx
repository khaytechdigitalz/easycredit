...
const TABLE_HEAD = [
  ...
  { id: 'name', label: 'GL Code', align: 'left' },
  { id: 'name', label: 'Account Type', align: 'left' },
  { id: 'name', label: 'Active', align: 'left' }, 
  { id: 'inventoryType', label: 'Manual Entry Allowed', align: 'center', width: 180 },
  { id: '' },
];
