...
const TABLE_HEAD = [
  { id: 'name', label: 'Enrty ID', align: 'left' },
  { id: 'name', label: 'Branch', align: 'left' },
  { id: 'createdAt', label: 'Transaction Date', align: 'left' },
  { id: 'createdAt', label: 'Transaction', align: 'left' },
  { id: 'createdAt', label: 'Type', align: 'left' },
  { id: 'createdAt', label: 'Created At', align: 'left' },
  { id: 'createdAt', label: 'Account', align: 'left' },
  { id: 'inventoryType', label: 'Debit', align: 'center', width: 180 },
  { id: 'price', label: 'Credit', align: 'right' },
  { id: '' },
];
...
export default function EcommerceProductListPage() {
  ...
  return (
    <>
      <Head>
        <title> Accounting: Chart Of Account | Easy Credit</title>
      </Head>
