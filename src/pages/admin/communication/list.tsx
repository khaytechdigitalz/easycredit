...
const TABLE_HEAD = [
  ...
  { id: 'name', label: 'Created By', align: 'left' },
  { id: 'name', label: 'Campaign Type', align: 'left' },
...
export default function EcommerceProductListPage() {
  ...
  return (
    <>
      <Head>
        <title> Campaigns: View Campaigns | Easy Credit</title>
      </Head>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          action={
            <Button
              component={NextLink}
              href={PATH_DASHBOARD.communication.create}
              variant="contained"
