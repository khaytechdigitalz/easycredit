      ...
      <Container maxWidth={themeStretch ? false : 'xl'}>
        ...
        <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4}>
              <BookingWidgetSummary image="/assets/icons/loan/AwaitingDisbursement.png" title="Awaiting Disbursement" total={loanstat?.awaitingDisbursement ? loanstat.awaitingDisbursement : '0'} icon={<BookingIllustration />} />
            </Grid>

            <Grid item xs={12} md={4}>
              <BookingWidgetSummary image="/assets/icons/loan/PendingApproval.png" title="Pending Approval" total={loanstat?.pendingApproval ? loanstat.pendingApproval : '0'} icon={<BookingIllustration />} />
            </Grid>

            <Grid item xs={12} md={4}>
              <BookingWidgetSummary image="/assets/icons/loan/Rejected.png" title="Rejected" total={loanstat?.rejected ? loanstat.rejected : '0'} icon={<BookingIllustration />} />
            </Grid>

            <Grid item xs={12} md={4}>
              <BookingWidgetSummary image="/assets/icons/loan/LoanDisbursed.png" title="Closed" total={loanstat?.closed ? loanstat.closed : '0'} icon={<BookingIllustration />} />
            </Grid>

            <Grid item xs={12} md={4}>
              <BookingWidgetSummary image="/assets/icons/loan/Loans.png" title="Active" total={loanstat?.active ? loanstat.active : '0'} icon={<BookingIllustration />} />
            </Grid>

            <Grid item xs={12} md={4}>
              <BookingWidgetSummary image="/assets/icons/loan/Rejected.png" title="Defaulted" total={loanstat?.defaulted ? loanstat.defaulted : '0'} icon={<BookingIllustration />} />
            </Grid>
        </Grid>
          <br/>
