...
const TABLE_HEAD = [
  ...
  { id: 'name', label: 'Loan Officer', align: 'left' },
  { id: 'name', label: 'Client', align: 'left' }, 
  { id: 'name', label: 'Amount', align: 'left' }, 
  { id: 'name', label: 'Balance', align: 'left' }, 
  { id: 'name', label: 'Disbursed', align: 'left' }, 
...
export default function EcommerceProductListPage() {
  ...
  return (
    <>
      <Head>
        <title> Loan: Loan Products | Easy Credit</title>
      </Head>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          action={
            <Button
              component={NextLink}
              href={PATH_DASHBOARD.loan.create_new_loan}
              variant="contained"
