    ...
    <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
      <Grid container spacing={3}>
        <Grid item xs={12} md={12}>
          ...
          <Card>
          <CardHeader title="Loan Calculator" subheader="Loan Calculator Inputs" sx={{ mb: 3 }} />
          ...
          <Stack spacing={3} sx={{ p: 3 }}>
            ...
            <RHFTextField name="fund" label="Principal" />

            <RHFTextField name="fund" label="Long Term" />
            ...
            >
              <optgroup>
                ...
                <option value="yes">Principal Due On Installment</option>
              </optgroup>
            </RHFSelect>

            <RHFTextField name="fund" label="Interest Rate" />
            <RHFTextField name="fund" label="Expected Disbursement Date" />
            <RHFTextField name="fund" label="Disbursement First Repayment date" />
